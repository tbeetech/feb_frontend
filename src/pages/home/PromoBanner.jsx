...
const PromoBanner = () => {
  return (
    <section className="section__container banner__container grid grid-cols-1 md:grid-cols-3 gap-6 py-12">
      ...
      <div className="banner__card bg-white p-6 rounded-lg shadow-lg text-center">
        <span className="text-black text-4xl" style={{color: '#000 !important'}}><FaHeadset className="mx-auto" style={{color: '#000 !important'}} /></span>
      ...
      <div className="banner__card bg-white p-6 rounded-lg shadow-lg text-center">
        <span className="text-black text-4xl" style={{color: '#000 !important'}}><FaLock className="mx-auto" style={{color: '#000 !important'}} /></span>
