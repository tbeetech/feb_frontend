...
const DealsSection = () => {
  ...
  return (
    <section className="section__container deals__container flex flex-col md:flex-row items-center justify-between py-12 bg-gradient-to-r from-pearl to-white">
      <motion.div 
        ...
        viewport={{ once: true }}
      >
        <img src={dealsImg} alt="deals" className="w-full h-auto rounded-lg shadow-luxury" />
      </motion.div>
      <motion.div 
        ...
        viewport={{ once: true }}
      >
        <h5 className="text-lg text-gold">Get Up To 20% Discount</h5>
        <h4 className="text-4xl font-bold text-off-black mt-2 font-display">Deals Of This Month</h4>
        ...
        <div className="deals__countdown flex justify-center md:justify-start gap-4 mt-6">
          <div className="deals__countdown__card bg-white border border-gold text-gold p-4 rounded-lg shadow-luxury transform transition-transform hover:scale-105 hover:bg-gold hover:text-white">
